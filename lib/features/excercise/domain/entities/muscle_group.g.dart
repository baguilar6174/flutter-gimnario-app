...
extension MuscleGroupQueryFilter
  ...
  QueryBuilder<MuscleGroup, MuscleGroup, QAfterFilterCondition> parentIdEqualTo(
      int? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'parentId',
  ...
  QueryBuilder<MuscleGroup, MuscleGroup, QAfterFilterCondition> parentIdBetween(
    int? lower,
    int? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension MuscleGroupQuerySortBy
  ...
  QueryBuilder<MuscleGroup, MuscleGroup, QAfterSortBy> sortByDescription() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'description', Sort.asc);
    });
  }

  QueryBuilder<MuscleGroup, MuscleGroup, QAfterSortBy> sortByDescriptionDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MuscleGroup, MuscleGroup, QAfterSortBy> sortByParentId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'parentId', Sort.asc);
    });
  }

  QueryBuilder<MuscleGroup, MuscleGroup, QAfterSortBy> sortByParentIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension MuscleGroupQuerySortThenBy
  ...
  QueryBuilder<MuscleGroup, MuscleGroup, QAfterSortBy> thenByDescription() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'description', Sort.asc);
    });
  }

  QueryBuilder<MuscleGroup, MuscleGroup, QAfterSortBy> thenByDescriptionDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'description', Sort.desc);
    });
  }
  ...
  QueryBuilder<MuscleGroup, MuscleGroup, QAfterSortBy> thenByParentId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'parentId', Sort.asc);
    });
  }

  QueryBuilder<MuscleGroup, MuscleGroup, QAfterSortBy> thenByParentIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'parentId', Sort.desc);
    });
  }
...
extension MuscleGroupQueryWhereDistinct
  ...
  QueryBuilder<MuscleGroup, MuscleGroup, QDistinct> distinctByDescription(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MuscleGroup, MuscleGroup, QDistinct> distinctByParentId() {
    return QueryBuilder.apply(this, (query) {
...
extension MuscleGroupQueryProperty
  ...
  QueryBuilder<MuscleGroup, String?, QQueryOperations> descriptionProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MuscleGroup, int?, QQueryOperations> parentIdProperty() {
    return QueryBuilder.apply(this, (query) {
